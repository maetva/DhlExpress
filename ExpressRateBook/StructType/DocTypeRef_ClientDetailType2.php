...
/**
 * This class stands for docTypeRef_ClientDetailType2 StructType
 * @subpackage Structs
 */
class DocTypeRef_ClientDetailType2 extends AbstractStructBase
{
    /**
     * The sso
    ...
    /**
     * Constructor method for docTypeRef_ClientDetailType2
     * @uses DocTypeRef_ClientDetailType2::setSso()
     * @uses DocTypeRef_ClientDetailType2::setPlant()
     * @param string $sso
     * @param string $plant
     */
     ...
     * Set sso value
     * @param string $sso
     * @return \Drupal\commerce_dhl_express\Endpoint\ExpressRateBook\StructType\DocTypeRef_ClientDetailType2
     */
