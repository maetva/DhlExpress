...
class DocumentImage extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $documentImageType = null, ?\Maetva\DhlExpress\ExpressRateBook\StructType\DocumentImage $documentImage = null, ?string $documentImageFormat = null)
    {
        $this
     ...
     * @uses \Maetva\DhlExpress\ExpressRateBook\EnumType\DocumentImageType::valueIsValid()
     * @uses \Maetva\DhlExpress\ExpressRateBook\EnumType\DocumentImageType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $documentImageType
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\DocumentImage
     */
    public function setDocumentImageType(?string $documentImageType = null): self
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\ExpressRateBook\EnumType\DocumentImageType::valueIsValid($documentImageType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\ExpressRateBook\EnumType\DocumentImageType', is_array($documentImageType) ? implode(', ', $documentImageType) : var_export($documentImageType, true), implode(', ', \Maetva\DhlExpress\ExpressRateBook\EnumType\DocumentImageType::getValidValues())), __LINE__);
        }
     ...
     * @uses \Maetva\DhlExpress\ExpressRateBook\EnumType\DocumentImageFormat::valueIsValid()
     * @uses \Maetva\DhlExpress\ExpressRateBook\EnumType\DocumentImageFormat::getValidValues()
     * @throws InvalidArgumentException
     * @param string $documentImageFormat
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\DocumentImage
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\ExpressRateBook\EnumType\DocumentImageFormat::valueIsValid($documentImageFormat)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\ExpressRateBook\EnumType\DocumentImageFormat', is_array($documentImageFormat) ? implode(', ', $documentImageFormat) : var_export($documentImageFormat, true), implode(', ', \Maetva\DhlExpress\ExpressRateBook\EnumType\DocumentImageFormat::getValidValues())), __LINE__);
        }
