...
class DocTypeRef_ChargesType extends AbstractStructBase
{
     ...
     * Set Currency value
     * @param string $currency
     * @return \Drupal\commerce_dhl_express\Endpoint\ExpressRateBook\StructType\DocTypeRef_ChargesType
     */
    ...
    public static function validateChargeForArrayConstraintsFromSetCharge(?array $values = []): string
    {
        ...
        foreach ($values as $docTypeRef_ChargesTypeChargeItem) {
            ...
            if (!$docTypeRef_ChargesTypeChargeItem instanceof \Drupal\commerce_dhl_express\Endpoint\ExpressRateBook\StructType\DocTypeRef_ChargeType) {
