...
/**
 * This class stands for docTypeRef_AddressType1 StructType
 * @subpackage Structs
 */
class DocTypeRef_AddressType1 extends AbstractStructBase
{
    /**
     * The StreetLines
     ...
     * The StreetName
     * Meta information extracted from the WSDL
     * - documentation: Shipper street name should be sent as separate attribute if feasible.
     * - base: xsd:token
     * - maxLength: 250
     * - minLength: 1
     * - minOccurs: 0
     ...
     * The StreetNumber
     * Meta information extracted from the WSDL
     * - documentation: Street number should be sent as separate attribute, if feasible.
     * - base: xsd:token
     * - maxLength: 50
     * - minLength: 1
     * - minOccurs: 0
     ...
     * The CountryCode
     * Meta information extracted from the WSDL
     * - documentation: ISO 2 character codes of the country | ISO 2 character codes of the Shipper/Recipient country
     * - base: xsd:string
     * - maxLength: 2
     * - minLength: 2
     * - whiteSpace: collapse
    ...
    /**
     * Constructor method for docTypeRef_AddressType1
     * @uses DocTypeRef_AddressType1::setStreetLines()
     * @uses DocTypeRef_AddressType1::setStreetName()
     * @uses DocTypeRef_AddressType1::setBuildingName()
     * @uses DocTypeRef_AddressType1::setStreetNumber()
     * @uses DocTypeRef_AddressType1::setStreetLines2()
     * @uses DocTypeRef_AddressType1::setStreetLines3()
     * @uses DocTypeRef_AddressType1::setCityDistrict()
     * @uses DocTypeRef_AddressType1::setCity()
     * @uses DocTypeRef_AddressType1::setStateOrProvinceCode()
     * @uses DocTypeRef_AddressType1::setStateOrProvinceName()
     * @uses DocTypeRef_AddressType1::setPostalCode()
     * @uses DocTypeRef_AddressType1::setCountryName()
     * @uses DocTypeRef_AddressType1::setCountryCode()
     * @uses DocTypeRef_AddressType1::setSuburb()
     ...
     * @param string $suburb
     */
    public function __construct(?string $streetLines = null, ?string $streetName = null, ?string $buildingName = null, ?string $streetNumber = null, ?string $streetLines2 = null, ?string $streetLines3 = null, ?string $cityDistrict = null, ?string $city = null, ?string $stateOrProvinceCode = null, ?string $stateOrProvinceName = null, ?string $postalCode = null, ?string $countryName = null, ?string $countryCode = null, ?string $suburb = null)
    {
        $this
     ...
     * @param string $streetLines
     * @return \Drupal\commerce_dhl_express\Endpoint\ExpressRateBook\StructType\DocTypeRef_AddressType1
     */
    ...
    public function setCityDistrict(?string $cityDistrict = null): self
    {
        ...
        if (!is_null($cityDistrict) && mb_strlen((string) $cityDistrict) > 35) {
            throw new InvalidArgumentException(sprintf('Invalid length of %s, the number of characters/octets contained by the literal must be less than or equal to 35', mb_strlen((string) $cityDistrict)), __LINE__);
        }
        // validation for constraint: minLength(1)
