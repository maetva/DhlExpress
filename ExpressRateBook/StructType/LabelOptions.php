...
class LabelOptions extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerLogo|null
     */
    protected ?\Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerLogo $CustomerLogo = null;
    /**
     * The CustomerBarcode
     * Meta information extracted from the WSDL
     * - documentation: Customer barcode to be printed on supported transport label templates
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerBarcode|null
     */
    protected ?\Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerBarcode $CustomerBarcode = null;
    /**
     * The PrinterDPI
     * Meta information extracted from the WSDL
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\DetachOptions|null
     */
    protected ?\Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\DetachOptions $DetachOptions = null;
    /**
     ...
     * @param \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerLogo $customerLogo
     * @param \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerBarcode $customerBarcode
     ...
     * @param \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\DetachOptions $detachOptions
     ...
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerLogo|null
     */
    public function getCustomerLogo(): ?\Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerLogo
    {
     ...
     * @param \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerLogo $customerLogo
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    public function setCustomerLogo(?\Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerLogo $customerLogo = null): self
    {
     ...
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerBarcode|null
     */
    public function getCustomerBarcode(): ?\Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerBarcode
    {
     ...
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    public function setCustomerBarcode(?\Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\CustomerBarcode $customerBarcode = null): self
    {
     ...
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestWaybillDocument::valueIsValid()
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestWaybillDocument::getValidValues()
    ...
    public function setRequestWaybillDocument(?string $requestWaybillDocument = null): self
    {
        ...
        if (!\Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestWaybillDocument::valueIsValid($requestWaybillDocument)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestWaybillDocument', is_array($requestWaybillDocument) ? implode(', ', $requestWaybillDocument) : var_export($requestWaybillDocument, true), implode(', ', \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestWaybillDocument::getValidValues())), __LINE__);
        }
     ...
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\HideAccountInWaybillDocument::valueIsValid()
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\HideAccountInWaybillDocument::getValidValues()
     * @throws InvalidArgumentException
     * @param string $hideAccountInWaybillDocument
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\HideAccountInWaybillDocument::valueIsValid($hideAccountInWaybillDocument)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\HideAccountInWaybillDocument', is_array($hideAccountInWaybillDocument) ? implode(', ', $hideAccountInWaybillDocument) : var_export($hideAccountInWaybillDocument, true), implode(', ', \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\HideAccountInWaybillDocument::getValidValues())), __LINE__);
        }
     ...
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\NumberOfWaybillDocumentCopies::valueIsValid()
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\NumberOfWaybillDocumentCopies::getValidValues()
     * @throws InvalidArgumentException
     * @param string $numberOfWaybillDocumentCopies
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\NumberOfWaybillDocumentCopies::valueIsValid($numberOfWaybillDocumentCopies)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\NumberOfWaybillDocumentCopies', is_array($numberOfWaybillDocumentCopies) ? implode(', ', $numberOfWaybillDocumentCopies) : var_export($numberOfWaybillDocumentCopies, true), implode(', ', \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\NumberOfWaybillDocumentCopies::getValidValues())), __LINE__);
        }
     ...
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestDHLCustomsInvoice::valueIsValid()
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestDHLCustomsInvoice::getValidValues()
     * @throws InvalidArgumentException
     * @param string $requestDHLCustomsInvoice
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestDHLCustomsInvoice::valueIsValid($requestDHLCustomsInvoice)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestDHLCustomsInvoice', is_array($requestDHLCustomsInvoice) ? implode(', ', $requestDHLCustomsInvoice) : var_export($requestDHLCustomsInvoice, true), implode(', ', \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestDHLCustomsInvoice::getValidValues())), __LINE__);
        }
     ...
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\DHLCustomsInvoiceType::valueIsValid()
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\DHLCustomsInvoiceType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $dHLCustomsInvoiceType
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\DHLCustomsInvoiceType::valueIsValid($dHLCustomsInvoiceType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\DHLCustomsInvoiceType', is_array($dHLCustomsInvoiceType) ? implode(', ', $dHLCustomsInvoiceType) : var_export($dHLCustomsInvoiceType, true), implode(', ', \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\DHLCustomsInvoiceType::getValidValues())), __LINE__);
        }
     ...
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestShipmentReceipt::valueIsValid()
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestShipmentReceipt::getValidValues()
     * @throws InvalidArgumentException
     * @param string $requestShipmentReceipt
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestShipmentReceipt::valueIsValid($requestShipmentReceipt)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestShipmentReceipt', is_array($requestShipmentReceipt) ? implode(', ', $requestShipmentReceipt) : var_export($requestShipmentReceipt, true), implode(', ', \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestShipmentReceipt::getValidValues())), __LINE__);
        }
     ...
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\DetachOptions|null
     */
    public function getDetachOptions(): ?\Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\DetachOptions
    {
     ...
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    public function setDetachOptions(?\Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\DetachOptions $detachOptions = null): self
    {
     ...
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestBarcodeInfo::valueIsValid()
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestBarcodeInfo::getValidValues()
     * @throws InvalidArgumentException
     * @param string $requestBarcodeInfo
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestBarcodeInfo::valueIsValid($requestBarcodeInfo)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestBarcodeInfo', is_array($requestBarcodeInfo) ? implode(', ', $requestBarcodeInfo) : var_export($requestBarcodeInfo, true), implode(', ', \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestBarcodeInfo::getValidValues())), __LINE__);
        }
     ...
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestLabelsToFitA4::valueIsValid()
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestLabelsToFitA4::getValidValues()
     * @throws InvalidArgumentException
     * @param string $requestLabelsToFitA4
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestLabelsToFitA4::valueIsValid($requestLabelsToFitA4)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestLabelsToFitA4', is_array($requestLabelsToFitA4) ? implode(', ', $requestLabelsToFitA4) : var_export($requestLabelsToFitA4, true), implode(', ', \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestLabelsToFitA4::getValidValues())), __LINE__);
        }
     ...
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestDHLLogoOnLabel::valueIsValid()
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestDHLLogoOnLabel::getValidValues()
     * @throws InvalidArgumentException
     * @param string $requestDHLLogoOnLabel
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestDHLLogoOnLabel::valueIsValid($requestDHLLogoOnLabel)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestDHLLogoOnLabel', is_array($requestDHLLogoOnLabel) ? implode(', ', $requestDHLLogoOnLabel) : var_export($requestDHLLogoOnLabel, true), implode(', ', \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestDHLLogoOnLabel::getValidValues())), __LINE__);
        }
     ...
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestTransportLabel::valueIsValid()
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestTransportLabel::getValidValues()
     * @throws InvalidArgumentException
     * @param string $requestTransportLabel
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestTransportLabel::valueIsValid($requestTransportLabel)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestTransportLabel', is_array($requestTransportLabel) ? implode(', ', $requestTransportLabel) : var_export($requestTransportLabel, true), implode(', ', \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestTransportLabel::getValidValues())), __LINE__);
        }
     ...
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestQRCode::valueIsValid()
     * @uses \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestQRCode::getValidValues()
     * @throws InvalidArgumentException
     * @param string $requestQRCode
     * @return \Maetva\DhlExpress\Endpoint\ExpressRateBook\StructType\LabelOptions
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestQRCode::valueIsValid($requestQRCode)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestQRCode', is_array($requestQRCode) ? implode(', ', $requestQRCode) : var_export($requestQRCode, true), implode(', ', \Maetva\DhlExpress\Endpoint\ExpressRateBook\EnumType\RequestQRCode::getValidValues())), __LINE__);
        }
