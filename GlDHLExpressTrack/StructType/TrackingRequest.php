...
class TrackingRequest extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\StructType\DocTypeRef_ClientDetailType|null
     */
    protected ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\DocTypeRef_ClientDetailType $ClientDetail = null;
    /**
     * The Request
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\StructType\Request|null
     */
    protected ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Request $Request = null;
    /**
     * The LanguageCode
     * Meta information extracted from the WSDL
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfAWBNumber|null
     */
    protected ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfAWBNumber $AWBNumber = null;
    /**
     * The LPNumber
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfTrackingPieceID|null
     */
    protected ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfTrackingPieceID $LPNumber = null;
    /**
     * The ReferenceQuery
     * Meta information extracted from the WSDL
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ReferenceQuery|null
     */
    protected ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\ReferenceQuery $ReferenceQuery = null;
    /**
     * The LevelOfDetails
     * Meta information extracted from the WSDL
     ...
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\StructType\DocTypeRef_ClientDetailType $clientDetail
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\StructType\Request $request
     * @param string $languageCode
     * @param string $languageScriptCode
     * @param string $languageCountryCode
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfAWBNumber $aWBNumber
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfTrackingPieceID $lPNumber
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ReferenceQuery $referenceQuery
     * @param string $levelOfDetails
     * @param string $piecesEnabled
     * @param bool $estimatedDeliveryDateEnabled
     */
    public function __construct(?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\DocTypeRef_ClientDetailType $clientDetail = null, ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Request $request = null, ?string $languageCode = null, ?string $languageScriptCode = null, ?string $languageCountryCode = null, ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfAWBNumber $aWBNumber = null, ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfTrackingPieceID $lPNumber = null, ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\ReferenceQuery $referenceQuery = null, ?string $levelOfDetails = null, ?string $piecesEnabled = null, ?bool $estimatedDeliveryDateEnabled = null)
    {
        $this
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\DocTypeRef_ClientDetailType|null
     */
    public function getClientDetail(): ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\DocTypeRef_ClientDetailType
    {
     ...
     */
    public function setClientDetail(?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\DocTypeRef_ClientDetailType $clientDetail = null): self
    {
    ...
    /**
     * Get Request value
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\Request|null
     */
    public function getRequest(): ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Request
    {
        return $this->Request;
    }
    /**
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\TrackingRequest
     */
    public function setRequest(?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Request $request = null): self
    {
    ...
    /**
     * Get AWBNumber value
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfAWBNumber|null
     */
    public function getAWBNumber(): ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfAWBNumber
    {
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\TrackingRequest
     */
    public function setAWBNumber(?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfAWBNumber $aWBNumber = null): self
    {
    ...
    /**
     * Get LPNumber value
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfTrackingPieceID|null
     */
    public function getLPNumber(): ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfTrackingPieceID
    {
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\TrackingRequest
     */
    public function setLPNumber(?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfTrackingPieceID $lPNumber = null): self
    {
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ReferenceQuery|null
     */
    public function getReferenceQuery(): ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\ReferenceQuery
    {
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\TrackingRequest
     */
    public function setReferenceQuery(?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\ReferenceQuery $referenceQuery = null): self
    {
     ...
     * @uses \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\LevelOfDetails::valueIsValid()
     * @uses \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\LevelOfDetails::getValidValues()
    ...
    public function setLevelOfDetails(?string $levelOfDetails = null): self
    {
        ...
        if (!\Maetva\DhlExpress\GlDHLExpressTrack\EnumType\LevelOfDetails::valueIsValid($levelOfDetails)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\LevelOfDetails', is_array($levelOfDetails) ? implode(', ', $levelOfDetails) : var_export($levelOfDetails, true), implode(', ', \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\LevelOfDetails::getValidValues())), __LINE__);
        }
     ...
     * @uses \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\PiecesEnabled::valueIsValid()
     * @uses \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\PiecesEnabled::getValidValues()
     * @throws InvalidArgumentException
     * @param string $piecesEnabled
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\TrackingRequest
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Maetva\DhlExpress\GlDHLExpressTrack\EnumType\PiecesEnabled::valueIsValid($piecesEnabled)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\PiecesEnabled', is_array($piecesEnabled) ? implode(', ', $piecesEnabled) : var_export($piecesEnabled, true), implode(', ', \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\PiecesEnabled::getValidValues())), __LINE__);
        }
