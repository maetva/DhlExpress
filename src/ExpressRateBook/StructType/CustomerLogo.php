...
class CustomerLogo extends AbstractStructBase
{
     ...
     * Set LogoImage value
     * @param string $logoImage
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\CustomerLogo
     */
     ...
     * @uses \Maetva\DhlExpress\ExpressRateBook\EnumType\LogoImageFormat::valueIsValid()
     * @uses \Maetva\DhlExpress\ExpressRateBook\EnumType\LogoImageFormat::getValidValues()
