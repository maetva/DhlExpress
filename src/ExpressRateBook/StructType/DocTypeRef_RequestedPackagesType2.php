...
class DocTypeRef_RequestedPackagesType2 extends AbstractStructBase
{
    /**
     * The Weight
     * @var \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_WeightType|null
     */
    protected ?\Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_WeightType $Weight = null;
    /**
     * The Dimensions
     * @var \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType2|null
     */
    protected ?\Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType2 $Dimensions = null;
    /**
     * The PackageTypeCode
     ...
     * @param \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_WeightType $weight
     * @param \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType2 $dimensions
     * @param string $packageTypeCode
     * @param int $number
     */
    public function __construct(?\Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_WeightType $weight = null, ?\Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType2 $dimensions = null, ?string $packageTypeCode = null, ?int $number = null)
    {
        $this
            ->setWeight($weight)
    ...
    /**
     * Get Weight value
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_WeightType|null
     */
    public function getWeight(): ?\Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_WeightType
    {
        return $this->Weight;
    }
    /**
     ...
     */
    public function setWeight(?\Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_WeightType $weight = null): self
    {
        $this->Weight = $weight;
     ...
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType2|null
     */
    public function getDimensions(): ?\Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType2
    {
     ...
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_RequestedPackagesType2
     */
    public function setDimensions(?\Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType2 $dimensions = null): self
    {
