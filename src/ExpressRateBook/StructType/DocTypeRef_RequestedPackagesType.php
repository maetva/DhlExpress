...
class DocTypeRef_RequestedPackagesType extends AbstractStructBase
{
    ...
    /**
     * The Dimensions
     * @var \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType|null
     */
    protected ?\Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType $Dimensions = null;
    /**
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\ExpressRateBook\StructType\BespokeLabelData|null
     */
    protected ?\Maetva\DhlExpress\ExpressRateBook\StructType\BespokeLabelData $BespokeLabelData = null;
    /**
     * The PackageReferences
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\ExpressRateBook\StructType\PackageReferences|null
     */
    protected ?\Maetva\DhlExpress\ExpressRateBook\StructType\PackageReferences $PackageReferences = null;
    /**
     ...
     * @param \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType $dimensions
     * @param string $customerReferences
     * @param string $parentPieceIdentificationNumber
     * @param string $customerReferenceType
     * @param string $packageTypeCode
     * @param \Maetva\DhlExpress\ExpressRateBook\StructType\BespokeLabelData $bespokeLabelData
     * @param \Maetva\DhlExpress\ExpressRateBook\StructType\PackageReferences $packageReferences
     ...
     * @uses \Maetva\DhlExpress\ExpressRateBook\EnumType\UseOwnPieceIdentificationNumber::valueIsValid()
     * @uses \Maetva\DhlExpress\ExpressRateBook\EnumType\UseOwnPieceIdentificationNumber::getValidValues()
    ...
    public function setUseOwnPieceIdentificationNumber(?string $useOwnPieceIdentificationNumber = null): self
    {
        ...
        if (!\Maetva\DhlExpress\ExpressRateBook\EnumType\UseOwnPieceIdentificationNumber::valueIsValid($useOwnPieceIdentificationNumber)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\ExpressRateBook\EnumType\UseOwnPieceIdentificationNumber', is_array($useOwnPieceIdentificationNumber) ? implode(', ', $useOwnPieceIdentificationNumber) : var_export($useOwnPieceIdentificationNumber, true), implode(', ', \Maetva\DhlExpress\ExpressRateBook\EnumType\UseOwnPieceIdentificationNumber::getValidValues())), __LINE__);
        }
     ...
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType|null
     */
    public function getDimensions(): ?\Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType
    {
     ...
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_RequestedPackagesType
     */
    public function setDimensions(?\Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_DimensionsType $dimensions = null): self
    {
     ...
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\BespokeLabelData|null
     */
    public function getBespokeLabelData(): ?\Maetva\DhlExpress\ExpressRateBook\StructType\BespokeLabelData
    {
     ...
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_RequestedPackagesType
     */
    public function setBespokeLabelData(?\Maetva\DhlExpress\ExpressRateBook\StructType\BespokeLabelData $bespokeLabelData = null): self
    {
     ...
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\PackageReferences|null
     */
    public function getPackageReferences(): ?\Maetva\DhlExpress\ExpressRateBook\StructType\PackageReferences
    {
     ...
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_RequestedPackagesType
     */
    public function setPackageReferences(?\Maetva\DhlExpress\ExpressRateBook\StructType\PackageReferences $packageReferences = null): self
    {
