...
class DocTypeRef_Charges extends AbstractStructBase
{
    ...
    public static function validateChargeForArrayConstraintsFromSetCharge(?array $values = []): string
    {
        ...
        foreach ($values as $docTypeRef_ChargesChargeItem) {
            ...
            if (!$docTypeRef_ChargesChargeItem instanceof \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_ChargeType) {
     ...
     * @param \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_ChargeType[] $charge
     * @return \Maetva\DhlExpress\ExpressRateBook\StructType\DocTypeRef_Charges
     */
