...
class ShipmentInfo extends AbstractStructBase
{
     ...
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\StructType\OriginServiceArea|null
     */
    protected ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\OriginServiceArea $OriginServiceArea = null;
    /**
     * The DestinationServiceArea
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\StructType\DestinationServiceArea|null
     */
    protected ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\DestinationServiceArea $DestinationServiceArea = null;
    /**
     * The ShipperName
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\StructType\Shipper|null
     */
    protected ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Shipper $Shipper = null;
    /**
     * The Consignee
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\StructType\Consignee|null
     */
    protected ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Consignee $Consignee = null;
    /**
     * The ShipmentEvent
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfShipmentEvent|null
     */
    protected ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfShipmentEvent $ShipmentEvent = null;
    /**
     * The ShipperReference
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipperReference[]
     */
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfChildShipmentIdentificationNumbers|null
     */
    protected ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfChildShipmentIdentificationNumbers $ArrayOfChildShipmentIdentificationNumbers = null;
    /**
     ...
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\StructType\OriginServiceArea $originServiceArea
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\StructType\DestinationServiceArea $destinationServiceArea
     ...
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\StructType\Shipper $shipper
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\StructType\Consignee $consignee
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfShipmentEvent $shipmentEvent
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipperReference[] $shipperReference
     * @param string $estimatedDeliveryDate
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfChildShipmentIdentificationNumbers $arrayOfChildShipmentIdentificationNumbers
     */
    public function __construct(?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\OriginServiceArea $originServiceArea = null, ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\DestinationServiceArea $destinationServiceArea = null, ?string $shipperName = null, ?int $shipperAccountNumber = null, ?string $consigneeName = null, ?string $shipmentDate = null, ?string $pieces = null, ?string $weight = null, ?string $weightUnit = null, ?string $serviceType = null, ?string $shipmentDescription = null, ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Shipper $shipper = null, ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Consignee $consignee = null, ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfShipmentEvent $shipmentEvent = null, ?array $shipperReference = null, ?string $estimatedDeliveryDate = null, ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfChildShipmentIdentificationNumbers $arrayOfChildShipmentIdentificationNumbers = null)
    {
        $this
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\OriginServiceArea|null
     */
    public function getOriginServiceArea(): ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\OriginServiceArea
    {
     ...
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\StructType\OriginServiceArea $originServiceArea
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipmentInfo
     */
    public function setOriginServiceArea(?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\OriginServiceArea $originServiceArea = null): self
    {
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\DestinationServiceArea|null
     */
    public function getDestinationServiceArea(): ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\DestinationServiceArea
    {
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipmentInfo
     */
    public function setDestinationServiceArea(?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\DestinationServiceArea $destinationServiceArea = null): self
    {
     ...
     * @uses \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\WeightUnit::valueIsValid()
     * @uses \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\WeightUnit::getValidValues()
    ...
    public function setWeightUnit(?string $weightUnit = null): self
    {
        ...
        if (!\Maetva\DhlExpress\GlDHLExpressTrack\EnumType\WeightUnit::valueIsValid($weightUnit)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\WeightUnit', is_array($weightUnit) ? implode(', ', $weightUnit) : var_export($weightUnit, true), implode(', ', \Maetva\DhlExpress\GlDHLExpressTrack\EnumType\WeightUnit::getValidValues())), __LINE__);
        }
    ...
    /**
     * Get Shipper value
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\Shipper|null
     */
    public function getShipper(): ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Shipper
    {
        return $this->Shipper;
    }
    /**
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipmentInfo
     */
    public function setShipper(?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Shipper $shipper = null): self
    {
    ...
    /**
     * Get Consignee value
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\Consignee|null
     */
    public function getConsignee(): ?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Consignee
    {
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipmentInfo
     */
    public function setConsignee(?\Maetva\DhlExpress\GlDHLExpressTrack\StructType\Consignee $consignee = null): self
    {
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfShipmentEvent|null
     */
    public function getShipmentEvent(): ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfShipmentEvent
    {
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipmentInfo
     */
    public function setShipmentEvent(?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfShipmentEvent $shipmentEvent = null): self
    {
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipperReference[]
     */
    ...
    public static function validateShipperReferenceForArrayConstraintsFromSetShipperReference(?array $values = []): string
    {
        ...
        foreach ($values as $shipmentInfoShipperReferenceItem) {
            ...
            if (!$shipmentInfoShipperReferenceItem instanceof \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipperReference) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ShipperReference property can only contain items of type \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipperReference, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipperReference $item
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipmentInfo
     */
    public function addToShipperReference(\Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipperReference $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipperReference) {
            throw new InvalidArgumentException(sprintf('The ShipperReference property can only contain items of type \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipperReference, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfChildShipmentIdentificationNumbers|null
     */
    public function getArrayOfChildShipmentIdentificationNumbers(): ?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfChildShipmentIdentificationNumbers
    {
     ...
     * @return \Maetva\DhlExpress\GlDHLExpressTrack\StructType\ShipmentInfo
     */
    public function setArrayOfChildShipmentIdentificationNumbers(?\Maetva\DhlExpress\GlDHLExpressTrack\ArrayType\ArrayOfChildShipmentIdentificationNumbers $arrayOfChildShipmentIdentificationNumbers = null): self
    {
